...
API_ELI5_GRAPHQLAPIENDPOINTOUTPUT
API_ELI5_GRAPHQLAPIIDOUTPUT
ENV
REGION
Amplify Params - DO NOT EDIT */ /* eslint-disable comma-dangle */
...
async function processRecord(record) {
  ...
  const labelNames = await getLabelNames(bucketName, sizes.fillsize.key);
